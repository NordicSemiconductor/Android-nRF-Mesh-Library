...
/**
 * To be used as a wrapper class when creating a GenericPowerDefaultSet message.
 */
public class GenericPowerDefaultSet extends ApplicationMessage {

    private static final String TAG = GenericPowerDefaultSet.class.getSimpleName();
    private static final int OP_CODE = ApplicationMessageOpCodes.GENERIC_POWER_DEFAULT_SET;
    private static final int GENERIC_POWER_DEFAULT_SET_PARAMS_LENGTH = 2;

    private final int mPowerDefault;

    /**
     * Constructs GenericPowerDefaultSet message.
     *
     * @param appKey {@link ApplicationKey} key for this message
     * @param powerDefault Default power value
     * @throws IllegalArgumentException if any illegal arguments are passed
     */
    public GenericPowerDefaultSet(@NonNull final ApplicationKey appKey,
