...
/**
 * To be used as a wrapper class when creating a GenericPowerRangeSetUnacknowledged message.
 */
public class GenericPowerRangeSetUnacknowledged extends ApplicationMessage {

    private static final String TAG = GenericPowerRangeSetUnacknowledged.class.getSimpleName();
    private static final int OP_CODE = ApplicationMessageOpCodes.GENERIC_POWER_RANGE_SET_UNACKNOWLEDGED;
    ...
    /**
     * Constructs GenericPowerRangeSetUnacknowledged message.
     *
     ...
     */
    public GenericPowerRangeSetUnacknowledged(@NonNull final ApplicationKey appKey,
                                              final int rangeMin,
