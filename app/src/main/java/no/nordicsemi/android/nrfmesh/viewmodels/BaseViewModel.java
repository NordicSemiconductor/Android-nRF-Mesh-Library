...
import no.nordicsemi.android.nrfmesh.node.PowerLevelServerActivity;
import no.nordicsemi.android.nrfmesh.node.PowerLevelSetupServerActivity;
...
import no.nordicsemi.android.nrfmesh.node.TimeServerActivity;
import no.nordicsemi.android.nrfmesh.node.TimeSetupServerActivity;
...
import static no.nordicsemi.android.mesh.models.SigModelParser.GENERIC_POWER_LEVEL_SETUP_SERVER;
...
import static no.nordicsemi.android.mesh.models.SigModelParser.TIME_SERVER;
import static no.nordicsemi.android.mesh.models.SigModelParser.TIME_SETUP_SERVER;
...
public abstract class BaseViewModel extends ViewModel {
    ...
    public void navigateToModelActivity(@NonNull final Activity context, @NonNull final MeshModel model) {
        ...
        if (model.getModelId() == CONFIGURATION_SERVER) {
            ...
            intent = new Intent(context, PowerLevelServerActivity.class);
        } else if (model.getModelId() == GENERIC_POWER_LEVEL_SETUP_SERVER) {
            intent = new Intent(context, PowerLevelSetupServerActivity.class);
