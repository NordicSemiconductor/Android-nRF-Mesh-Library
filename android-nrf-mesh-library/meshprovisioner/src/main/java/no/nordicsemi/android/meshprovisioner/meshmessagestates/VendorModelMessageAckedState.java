...
public class VendorModelMessageAckedState extends VendorModelMessageState {
    ...
    public VendorModelMessageAckedState(final Context context, final ProvisionedMeshNode provisionedMeshNode,
