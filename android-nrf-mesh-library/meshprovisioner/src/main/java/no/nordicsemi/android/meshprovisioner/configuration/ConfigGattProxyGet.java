...
public class ConfigGattProxyGet extends ConfigMessage {
    ...
    public ConfigGattProxyGet(final Context context, final ProvisionedMeshNode provisionedMeshNode, final boolean aszmic,
    ...
    public MessageState getState() {
        return MessageState.CONFIG_GATT_PROXY_GET;
    }
    ...
    private void createAccessMessage() {
        ...
        final AccessMessage accessMessage = mMeshTransport.createMeshMessage(mProvisionedMeshNode, mSrc, key, akf, aid, mAszmic,
                ConfigMessageOpCodes.CONFIG_GATT_PROXY_GET, null);
