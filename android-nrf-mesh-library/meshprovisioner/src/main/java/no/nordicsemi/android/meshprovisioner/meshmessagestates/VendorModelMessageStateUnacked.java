...
public class VendorModelMessageStateUnacked extends VendorModelMessageState {

    private static final String TAG = VendorModelMessageStateUnacked.class.getSimpleName();
    ...
    public VendorModelMessageStateUnacked(final Context context, final ProvisionedMeshNode provisionedMeshNode,
