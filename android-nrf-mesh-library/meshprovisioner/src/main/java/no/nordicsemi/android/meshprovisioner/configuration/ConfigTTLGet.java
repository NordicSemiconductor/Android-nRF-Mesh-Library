...
public class ConfigTTLGet extends ConfigMessage {


    private static final String TAG = ConfigTTLGet.class.getSimpleName();

    private final int mAszmic;

    public ConfigTTLGet(final Context context, final ProvisionedMeshNode provisionedMeshNode, final boolean aszmic,
    ...
    public MessageState getState() {
        return MessageState.CONFIG_DEFAULT_TTL_GET;
    }
    ...
    private void createAccessMessage() {
        ...
        final AccessMessage accessMessage = mMeshTransport.createMeshMessage(mProvisionedMeshNode, mSrc, key, akf, aid, mAszmic,
                ConfigMessageOpCodes.CONFIG_DEFAULT_TTL_GET, null);
