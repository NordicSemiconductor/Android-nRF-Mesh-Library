...
public class ConfigRelayGet extends ConfigMessage {
    ...
    public ConfigRelayGet(final Context context, final ProvisionedMeshNode provisionedMeshNode, final boolean aszmic,
    ...
    public MessageState getState() {
        return MessageState.CONFIG_RELAY_GET;
    }
    ...
    private void createAccessMessage() {
        ...
        final AccessMessage accessMessage = mMeshTransport.createMeshMessage(mProvisionedMeshNode, mSrc, key, akf, aid, mAszmic,
                ConfigMessageOpCodes.CONFIG_RELAY_GET, null);
